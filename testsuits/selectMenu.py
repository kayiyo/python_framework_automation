...
def quoteInquiry():
    ...
    #     ".//*[@id='app']/div[2]/div[2]/div/div[1]/form/div[1]/div/div/div[1]/input"
    # )
    # driver.find_element_by_class_name("el-scrollbar__view el-select-dropdown__list").click()
    #
    # select.click()
    # Select.select_by_visible_text(u"已报价")
    #
    # select.find_element_by_xpath("html/body/div[3]/div/div[1]/ul/li[3]").get_attribute("data-id")
