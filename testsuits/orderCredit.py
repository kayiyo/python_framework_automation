...
# 进入登录界面
orderCredit.load(url);

# 输入用户名
orderCredit.inputusername(user);

# 输入密码
orderCredit.inputpassword(pw);
...
# 出库信息
orderCredit.ordercredit(ordersn);
