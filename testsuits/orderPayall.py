    ...
    def orderpayall(self, ordersn):
        ...
        while runforever:
            ...
            try:
                ...
                driver.switch_to_alert()
                driver.find_element_by_xpath(
                    ".//*[@id='app']/div[2]/div[2]/div/div/div[2]/div/div[3]/span/div/button[2]").click()
...
# 进入登录界面
orderPayall.load(url);

# 输入用户名
orderPayall.inputusername(user);

# 输入密码
orderPayall.inputpassword(pw);
