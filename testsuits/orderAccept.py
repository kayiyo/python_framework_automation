    ...
    def orderaccept(self, ordersn):
        ...
        while runforever:
            ...
            try:
                ...
                inputbox.clear()
                inputbox.send_keys(u"青岛码头交收" + "ddgl")

                # 交收时间
                inputbox = driver.find_element_by_xpath(
                    ".//*[@id='app']/div[2]/div[2]/div/div/div[1]/div/div[2]/div/form/div[2]/div/div/div/div/div/input")
                inputbox.clear()
...
# 输入用户名
orderAccept.inputusername(user);

# 输入密码
orderAccept.inputpassword(pw);
...
# 出库信息
orderAccept.orderaccept(ordersn);
